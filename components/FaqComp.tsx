...
const FaqComp = ({ title, content }: AccordionProps) => {
  ...
  return (
    <div
      ...
      className=" mb-4 w-full cursor-pointer border-[3px] dark:bg-gray-200 gradient-border rounded-xl"
    >
      <div
        className={
          " h-[4.5rem] max-sm:h-14 p-8 flex justify-between items-center text-black rounded-xl"
        }
      >
