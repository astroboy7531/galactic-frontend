...
export default function Footer() {
  ...
  return (
    <div className="flex flex-col items-center relative z-[10] bg-[#F9F9F9] dark:bg-dark pt-[50px] py-8 font-Josefin">
      <div className="max-w-[1240px] relative w-full flex flex-col items-center gap-8">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="text-[#060C1E] dark:text-white text-center font-Josefin font-[500]">
            Join players all over the World in the battle for
            <br /> the throne to inherit the kingdom !
          </div>
        </div>
        ...
        <div className="flex flex-col gap-8 sm:gap-0 sm:flex-row w-full items-center justify-between text-sm font-Josefin dark:text-white text-[#060C1E]">
          ...
          <div>© 2024 Galactic Kingdom. All rights reserved.</div>
