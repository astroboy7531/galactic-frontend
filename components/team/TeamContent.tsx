...
export default function TeamContent() {
  ...
  return (
    <>
      {resolvedTheme === "dark" ? (
        <div className="w-full flex flex-col border-0 relative py-20  font-Josefin bg-[#C2C2C0] about-shadow-dark">
          <div className="w-full flex flex-col overflow-y-visible absolute z-10">
            {/* <div>
              <img
                className=" object-center object-cover min-w-[100%] top-[-150px] md:top-[-200px] lg:top-[-270px] relative"
                alt="cloud"
                src="/about/cloudTop.png"
              />
            </div> */}
            <MovingImage  />
          </div>
          <div className="w-full max-w-[1240px] z-10 flex flex-row lg:flex-col lg:gap-20 items-center justify-center px-10 mx-auto text-center pt-20 text-dark-text">
            <Fade bottom cascade>
              <div className="flex flex-col lg:flex-row justify-center gap-20  overflow-visible">
                ...
                >
                  ...
                  <div className="flex flex-col items-center gap-2 w-[80%] text-center">
                    ...
                    <p className="text-[#286F7C] text-sm">
                      Chief Executive Officer
                    </p>
                    <p className="text-sm">
                      Leading the project growth and development
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div className="flex flex-col items-center gap-2 w-[80%] text-center">
                    <h2 className="uppercase text-3xl font-[500]">
                      Evan Roberts
                    </h2>
                    <p className="text-[#C17506] text-sm">
                      Chief Product Officer
                    </p>
                    <p className="text-sm">
                      Gameplay, Game Economy & Tokenomic Design
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div className="flex flex-col items-center gap-2 w-[80%] text-center">
                    ...
                    <p className="text-sm">
                      Smart Contracts & Full Stack Architecture
                    </p>
                  </div>
                </div>
              </div>
            ...
            <Fade bottom cascade>
              <div className="flex flex-col lg:flex-row justify-center gap-20  overflow-visible">
                ...
                >
                  <div>
                    <img src="/secondPart/Pfo_2.png" alt="vector" />
                  </div>
                  <div className="flex flex-col items-center gap-2 w-[80%] text-center">
                    <h2 className="uppercase text-3xl font-[500]">
                      Michael Stan
                    ...
                    <p className="text-sm">
                      Web3 Law, ADRs & Legal Adviser/Representative
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="w-full flex flex-col border-0 relative py-12 font-Josefin bg-[#F0EBE5] about-shadow">
          ...
          <div className="w-full max-w-[1240px] z-10 flex flex-row lg:flex-col lg:gap-20 items-center justify-center px-10 mx-auto text-center pt-16 text-dark-text">
            <Fade bottom cascade>
              <div className="flex flex-col lg:flex-row justify-center gap-20  overflow-visible">
                <div
                  className="flex flex-col items-center gap-8"
