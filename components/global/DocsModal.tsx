...
const ContactList3Textarea = styled.input`
    display: flex;
    padding: 16px 16px;
    align-items: center;
    gap: 16px;
...
const DocsModal: React.FC<ContactModalProps> = ({ contactVisible, setContactVisible }) => {
    ...
    const validate = (password: string) => {
        ...
        if (!errorFlag) {
            ...
            window.location.href = "https://docs.galactickingdom.io/";
            //Email JS
                ...
                <ContactInner>
                    <MainContactForm>
                        ...
                        <ContactList2>
                            ...
                            <ContactList2Content>
                                Please enter the password to enther the docsaurus
                            </ContactList2Content>
                        </ContactList2>
                        <ContactList3>
                            <ContactList3Textarea placeholder='password' name='password' type='password' ref={passwordRef} />
                            <div className='text-[18px] text-red-700 pl-3 -mt-3'>{errorInfo.password}</div>
                        </ContactList3>
                        <CustomButtonWrap onClick={onSubmitHanlder}>
                            <CustomButton content='O K' />
                        </CustomButtonWrap>
                    </MainContactForm>
                </ContactInner>
                : <></>}
